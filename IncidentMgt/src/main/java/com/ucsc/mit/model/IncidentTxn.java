...
@Entity
@Table(name="incident_txn")
@ManagedBean(name="incidentTxn")
@Proxy(lazy=false)
public class IncidentTxn  implements Serializable {
	...
	public IncidentTxn(int id, int priorityId, int originId, int techId, int incTypeId, int incLocationId,
	...
	public String toString() {
		return "IncidentTxn [id=" + id + ", priorityId=" + priorityId + ", originId=" + originId + ", techId=" + techId
				+ ", incTypeId=" + incTypeId + ", incLocationId=" + incLocationId + ", incSubTypeId=" + incSubTypeId
				+ ", uCloseRId=" + uCloseRId + ", title=" + title + ", reportedBy=" + reportedBy + ", atUnitProcess="
				+ atUnitProcess + ", phone=" + phone + ", email=" + email + ", description=" + description + ", status="
				+ status + ", modifiedBy=" + modifiedBy + ", createdBy=" + createdBy + ", statusRemark=" + statusRemark
				+ ", incLocDetail=" + incLocDetail + ", otherDetail=" + irtCloseReasonId + ", occuranceDate=" + occuranceDate
