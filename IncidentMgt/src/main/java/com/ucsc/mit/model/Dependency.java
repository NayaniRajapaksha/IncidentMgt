...
@Entity
@Table(name="incident_dependency")
@ManagedBean(name="dependency")
@Proxy(lazy=false)
public class Dependency implements Serializable{
	...
	public Dependency(int dependency_id, int incident_id, int unit_id, int priority_id, int days, int hours,
	...
	public String toString() {
		return "Dependency [dependency_id=" + dependency_id + ", incident_id=" + incident_id + ", unit_id=" + unit_id
				+ ", priority_id=" + priority_id + ", days=" + days + ", hours=" + hours + ", minutes=" + minutes
				+ ", created_date=" + created_date + ", modified_date=" + modified_date + ", description=" + description
				+ ", dependency_status=" + dependency_status + ", assinged_member=" + assinged_member
				+ ", resolved_des=" + resolved_des + ", created_by=" + created_by + ", depend_close_reason="
				+ depend_close_reason + ", visible_status=" + visible_status + "]";
	}
